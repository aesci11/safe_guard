...
abstract class Palette {
  /// Chromatic color (유채색)
  static Color green = const Color(0xFF2FE291);
  static Color brightGreen = const Color(0xFFEBFDF4);
  static Color red = const Color(0xFFFF5208);
  static Color brightRed = const Color(0xFFFFEEE7);
  ...
  static Color grey350 = const Color(0xFFCDCDCD);
  static Color grey400 = const Color(0xFFB7B7B7);
  static Color grey500 = const Color(0xFF949494);
  static Color grey600 = const Color(0xFF787878);
